...
//		res=true;
		...
		System.out.println(numTestSteps);
		
		
		int colcnt = 5;
		String testcase[][] = new String[numTestSteps][colcnt];
		for(int i=0; i<numTestSteps; i++)
		{
			for(int j=0; j<colcnt; j++)
			{
				testcase[i][j] = library.getExcelData(config.Testpath, scenarioName, i, j);
			}
		}
		
		for(int p=1; p<numTestSteps; p++)
		{
			String action = testcase[p][0];
			String elementId = testcase[p][1];
			String locatorVal = testcase[p][2];
			String data = testcase[p][3];
			String darr = testcase[p][4];
...
//			System.out.println(darr);
			...
			try
			{
				...
				{
				case "type":
					te.type(elementId,locatorVal,data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "click":
					te.click(elementId, locatorVal, data);
					// pjsc.closesliderads(drv);
					// pjsc.closeTransistionads(drv);
					// Thread.sleep(1000);
					// pjsc.closebreakingnews(drv);
					pjsc.waitforPageLoad(drv);
					pjsc.verifyClickConnectionErrors(drv, data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "select":
					te.select(elementId, locatorVal, data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
				...
				case "verifyPageHeader":
					te.verifyPageHeader(elementId, locatorVal, data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifyleftrail":
					te.verifyleftrail(elementId, locatorVal, data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifyfrontmodules":
					te.verifyfrontmodules(elementId, locatorVal, data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifyscorecards":
					te.verifyscorecards(split[0], split[1], split[2]);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifystandingsheaders":
					te.verifystandingsheaders();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifystandingslegends":
					te.verifystandingslegends();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifystandingsseasons":
					te.verifystandingsseasons();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifystandingsdivisions":
					te.verifystandingsdivisions();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifystandingsribbons":
					te.verifystandingsribbons();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifyscheduledate":
					te.verifyscheduledate();
					//	System.out.println(res);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break; 
				
				case "verifyDefaultScheduleFilters":
					te.verifyDefaultScheduleFilters();
					//				System.out.println(res);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;

				case "verifyScheduleheaders":
					te.verifyScheduleheaders();
					// 				System.out.println(res);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifyweekribbon":
					te.verifyweekribbon();
					//	System.out.println(res);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
				...
				case "verifystatscolhighlight":
					te.verifystatscolhighlight(data, darr);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifystatsplayer":
					te.verifystatsplayer(locatorVal, data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifystatsplrstats":
					te.verifystatsplrstats(locatorVal, data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "webpagescrollup":
					te.webpagescrollup();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifydispofNFLldrmodule":
					te.verifydispofNFLldrmodule();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifydispofldrmodule":
					te.verifydispofldrmodule();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifyNFLfinalcards":
					te.verifyNFLfinalcards();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifyscrfinalcards":
					te.verifyscrfinalcards();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifycontextlinkclick":
					te.verifycontextlinkclick(split[0],split[1],darr,data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifyctrlonoverview":
					te.verifyctrlonoverview(split[0],split[1],darr);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifyMoreGamesCnt":
					te.verifyMoreGamesCnt(locatorVal, data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifydispofRecapTxtInfo":
					te.verifydispofRecapTxtInfo(locatorVal);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifyteamIndexCrdLinks":
					te.verifyteamIndexCrdLinks();
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifyTmIndexDrpdn":
				...
				case "waitforElement":
					te.waitforElement(elementId,locatorVal);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;
					
				case "verifypowerrankingsPageHeader":
					te.verifypowerrankingsPageHeader(locatorVal);
					//	System.out.println(res);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break; 	
					
				case "verifyPhotoModule":
					pjsc.PhotoModulechker(drv, locatorVal, data);
					//	library.writeToExcel(scenarioName, i, 4,result);
					break;	
...
//		}		
	...
	/*private void PhotoModulechker(String locatorVal, String data) {
...
//		System.out.println(scr.size());
	...
	public void verifypowerrankingsPageHeader(String xpath) throws Exception
	{
		String Passlog;
		String Faillog;
		ProjectSpecificComponents pjc = new ProjectSpecificComponents();
		
		String data = drv.findElement(By.xpath(xpath)).getText();
				if(pjc.powerrankingsPageHeader(data))
				{
					Passlog = "PASS - Power Rankings page header is displayed in following format --> USA TODAY POWER RANKINGS (Published On: YYYY-MM-DD)";
					report.writePassLog(Passlog);
				}
				else
				{
					res=false;
					Faillog = "FAIL - Power Rankings page header is not displayed in following format --> USA TODAY POWER RANKINGS (Published On: YYYY-MM-DD)";
					report.writeFailLog(Faillog);
				}
	...
	public void verifycontextlinkclick(String t1,String t2,String contextlink, String data) throws Exception
	{
		ProjectSpecificComponents pjc = new ProjectSpecificComponents();
		if(!pjc.contextlinkclick(drv, t1, t2, contextlink, data))
...
//			System.out.println("Selenium doesn't clicked on '"+contextlink+"' contextlink of teams '"+t1+"' Vs '"+t2+"'");
	...
	public void verifydispofldrmodule()
	{
		ProjectSpecificComponents pjc = new ProjectSpecificComponents();
		...
		if(pscrcards.size()!=0)
		{
			try
			{
				if(pjc.dispofldrmodule(drv,date))
				{
	...
	public void verifyscrfinalcards()
	{
		ProjectSpecificComponents pjc = new ProjectSpecificComponents();
		String date = drv.findElement(By.xpath("//input[@class='ui-date-picker sp-filter-date-picker-input hasDatepicker']")).getAttribute("value");
		List<WebElement> pscrcards = drv.findElements(By.xpath("//div[contains(@class,'post-event')]"));
	...
	public void verifyRankingsstats(String xpath, String data) throws Exception
	{
		ProjectSpecificComponents pjc = new ProjectSpecificComponents();
		pjc.Rankingsstats(drv, xpath, split2);
	}
