...
public class NBAHeader extends TestCase
{
	@Test
	public void testNBAHeader()
	{
		try
		{
			System.out.println("inside testNBAHeader test try block");
		...
		{
			System.out.println("inside testNBAHeader test catch block");
