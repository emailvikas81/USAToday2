...
public class NHLrankings extends TestCase
{
	@Test
	public void testNHLrankings()
	{
		try
		{
		System.out.println("inside testNHLrankings test try block");
		...
		{
			System.out.println("inside testNHLrankings test catch block");
