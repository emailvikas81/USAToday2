...
public class NFLrankings extends TestCase
{
	@Test
	public void testNFLrankings()
	{
		try
		{
		System.out.println("inside testNFLrankings test try block");
		...
		{
			System.out.println("inside testNFLrankings test catch block");
