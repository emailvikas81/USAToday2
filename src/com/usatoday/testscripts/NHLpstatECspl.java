...
public class NHLpstatECspl extends TestCase
{
	@Test
	public void testNHLpstatECspl()
	{
		try
		{
		System.out.println("inside testNHLpstatECspl test try block");
		...
		{
			System.out.println("inside testNHLpstatECspl test catch block");
