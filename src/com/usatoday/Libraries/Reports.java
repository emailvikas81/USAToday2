...
public class Reports {
	...
	public static int faillogcntr;
	public static int passlogcntr;
	public static int totlscenarios;
...
//********************************************************************************************************************
	...
	//		bw1.write("<table style=font-family:calibri  Align=center><tr><td width=200><img src=Usatoday_logo.jpg/></td><td width=500><B>Selenium Hybrid Automation Framework Implementation</B></td></tr></table>");
			...
			bw1.write("<tr><th width=760>"+sport+" TestCases Execution Summary Report</th></tr>");
			bw1.write("</table>");
			bw1.write("<table style=font-family:calibri border =1 cellspacing=1 frame=Vsides bgcolor=6699FF Align=Center>");
			bw1.write("<tr><td  width=500 ><B>Execution Started Time</B></td><td width=250><B>" +currtime+ "</B></td></tr>");
			bw1.write("<tr><td  width=500 ><B>Application URL </B></td><td width=250><B>"+Url+"</B></td></tr>");
			bw1.write("<tr><td  width=500 ><B>Environment </B></td><td width=250><B>"+Env+"</B></td></tr>");
			bw1.write("<tr><td  width=500 ><B>Browser </B></td><td width=250><B>"+Browser+"</B></td></tr>");
			bw1.write("<tr><td  width=500 ><B>Browser Version </B></td><td width=250><B>"+BrowserVersion+"</B></td></tr>");
			bw1.write("<tr><td  width=500 ><B>Operating System </B></td><td width=250><B>"+Os+"</B></td></tr>");
			bw1.write("<tr><td  width=500 ><B>Automation Tool</B></td><td width=250><B>Selenium</B></td></tr></table><br/>");
			bw1.write("<table style=font-family:calibri border =2 cellspacing=1 frame=Vsides bgcolor=#E8E8E8 Align=Center><tr><td Align=Center width=50><B>SL NO</B></td><td Align=center width=370><B>TestScript Name</B></td><td width=80 Align=center><B>Result</B></td><td width=90 Align=center><B>Total Scenarios</B></td><td width=90 Align=center><B>PASSED Scenarios</B></td><td width=90 Align=center><B>FAILED Scenarios</B></td></tr>");
			bw1.close();
		}
		catch(Exception e)
		{
...
//********************************************************************************************************************
	...
	public void writePassSummary(String scriptname, String status) throws IOException
	{
		try
		{
			...
			String sport = config.sports;
			int plogcntr = Reports.passlogcntr;
			int flogcntr = Reports.faillogcntr;
			int totlcntr = Reports.totlscenarios;
			BufferedWriter bw1 = new BufferedWriter(new FileWriter(rpath+"/"+sport+"_Summary.html",true));
			bw1.write("<tr><td Align=center>"+slno+"</td><td><a href="+scriptname+".html>"+scriptname+"</a></td><td bgcolor=#00FF00 Align=center>"+status+"</td><td Align=center>"+totlcntr+"</td><td bgcolor=#00FF00 Align=center>"+plogcntr+"</td><td bgcolor=#FF0000 Align=center>"+flogcntr+"</td></tr>");
			slno++;
			passcntr++;
			bw1.close();
		}
...
//********************************************************************************************************************
	...
	public void writeFailSummary(String scriptname, String status) throws IOException
	{
		try
		{
			...
			int totlcntr = Reports.totlscenarios;
			BufferedWriter bw1 = new BufferedWriter(new FileWriter(rpath+"/"+sport+"_Summary.html",true));
			bw1.write("<tr><td Align=center>"+slno+"</td><td><a href="+scriptname+".html>"+scriptname+"</a></td><td bgcolor=#FF0000 Align=center>"+status+"</td><td Align=center>"+totlcntr+"</td><td bgcolor=#00FF00 Align=center>"+plogcntr+"</td><td bgcolor=#FF0000 Align=center>"+flogcntr+"</td></tr>");
			slno++;
			failcntr++;
			bw1.close();
		}
